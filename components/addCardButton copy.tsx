const GetStartedButton = ({ onClick }) => {
    return (
        ...
        >
            ...
            {/* Shine Effect */}
            <div className="absolute inset-0 -left-full w-full h-full bg-gradient-to-r from-transparent via-white/90 to-transparent opacity-50 group-hover:opacity-60 group-hover:left-full transition-all duration-1000 ease-in-out"></div>
        </button>
    );
};
